defmodule News.DateModifiedTest do
  ...
  test "parse/1 return the Date when there's a dateModified in National Law Review format" do
  ...
  test "parse/1 return the Date when there's a dateModified in Ft. Worth Star Telegram format" do
